...
router.delete("/api/vendor/:id", (req, res) => {
    const { id } = req.params;
...
router.post("/api/kendaraan", (req, res) => {
...
router.get("/api/kendaraan", (req, res) => {
...
router.put("/api/kendaraan/:id", (req, res) => {
    const { id } = req.params;
    const { dt_mobil, plat } = req.body;
...
router.delete("/api/kendaraan/:id", (req, res) => {
    const { id } = req.params;
...
router.get("/api/sparepart", (req, res) => {
    db.query(
...
router.get("/api/barang_masuk/:id", (req, res) => {
    const { id } = req.params;
    db.query(
...
router.get("/api/stok_sparepart", (req, res) => {
    db.query(
        `SELECT s.*, v.nama_vendor 
     FROM stok_sparepart s 
     LEFT JOIN vendor v ON s.id_vendor = v.id
...
router.get("/api/pemakaian/:id", (req, res) => {
    const { id } = req.params;
    const sql = `
    SELECT 
      p.*,
...
router.delete("/api/pemakaian/:id", (req, res) => {
    const { id } = req.params;
...
router.get("/api/pemakaian_vendor", (req, res) => {
    try {
...
router.get("/api/histori_pemakaian", (req, res) => {
...
router.get("/api/histori_pemakaian/stats", (req, res) => {
    const sql = `
        SELECT 
...
router.get("/api/ban/tersedia", (req, res) => {
    try {
...
router.delete('/api/ban/:id', (req, res) => {
...
router.put("/api/pban/:id", (req, res) => {
    const { id } = req.params;
    const {
        seri_lama,
        km_awal,
...
router.put("/api/pban/edit/:id", (req, res) => {
    const { id } = req.params;
    const {
        seri_lama,
        merk_lama,
...
router.get("/api/rekap_lama", (req, res) => {
    try {
...
router.get("/api/rekap_ban", (req, res) => {
    try {
...
router.get("/api/ban_masuk", (req, res) => {
    try {
...
router.get("/api/stok_ban", (req, res) => {
    try {
        let { start, end, vendor, merkBan } = req.query;
...
router.get("/api/pemakaian_ban_per_masuk", (req, res) => {
    try {
...
router.get("/api/data_kendaraan", (req, res) => {
    try {
...
router.get("/api/oli_masuk", (req, res) => {
    db.query(
        `SELECT 
      om.*,
      v.nama_vendor,
...
router.get("/api/oli_masuk/:id", (req, res) => {
    const { id } = req.params;
    db.query(
        `SELECT 
      om.*,
...
router.get("/api/oli_lama", (req, res) => {
    const sql = `
    SELECT 
...
router.post("/api/oli_masuk", (req, res) => {
    const {
        tanggal_masuk,
        nama_oli,
        no_seri,
...
router.put("/api/oli_masuk/:id", (req, res) => {
    const { id } = req.params;
    const {
        tanggal_masuk,
        nama_oli,
...
router.get("/api/stok_oli", (req, res) => {
    db.query(
        `SELECT 
      so.id,
      so.id_oli_masuk,
...
router.post("/api/pemakaian_oli", (req, res) => {
    const {
        tanggal_pakai,
        id_oli_masuk,
        id_kendaraan,
...
router.get("/api/rekap/oli_masuk", (req, res) => {
...
router.get("/api/rekap/oli_tersedia", (req, res) => {
...
router.get("/api/rekap/pemakaian_oli", (req, res) => {
...
router.get("/api/rekap/pemakaian_per_bon", (req, res) => {
    try {
