...
const api = {
  ...
  async fetchPenukaranBan() {
    const response = await fetch("/api/pban/all");
    return await response.json();
  },

  async updatePenukaranBan(id, data) {
    const response = await fetch(`/api/pban/${id}`, {
      method: "PUT",
  ...
  async updatePenukaranBanEdit(id, data) {
    const response = await fetch(`/api/pban/edit/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data)
    });
  ...
  async createPenukaranBan(data) {
    const response = await fetch(`/api/pban`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data)
    });
